        ...
        <div className="bg-card p-5 sm:p-8 rounded-xl shadow-lg border border-border">
          ...
          <div className="bg-muted p-4 rounded-lg mb-6">
            ...
            <p className="text-xs text-muted-foreground mb-3">
              Réglez votre abonnement directement via le guichet marchand i-Pay
              (Mobile Money et carte bancaire).
            </p>
            <IPayButton label={`Payer ${fmt(PLAN.price)} avec i-Pay`} className="py-5" />
          </div>
          ...
          <div className="bg-muted p-4 rounded-lg mb-6">
            ...
            <ol className="text-xs space-y-2 text-muted-foreground list-decimal list-inside">
              <li>Cliquez sur <span className="font-bold text-card-foreground">Payer avec i-Pay</span> et réglez <span className="font-bold text-card-foreground">{fmt(PLAN.price)}</span></li>
              <li>Conservez le reçu de paiement i-Pay</li>
              <li>Envoyez votre reçu via WhatsApp avec le bouton ci-dessous</li>
              <li>L'administrateur validera votre abonnement (sous 24h)</li>
            </ol>
          </div>

          <Button
            onClick={() => handleWhatsAppContact("i-Pay")}
          ...
          >
            ...
            Envoyer mon reçu i-Pay via WhatsApp
          </Button>
